...
export const level1Problems: ProblemSeed[] = [
  // 基本型 Level 1
  {
    id: "primitive-types-1-01",
    ...
    hints: ["オブジェクト型は { } で定義します", "プロパティは「プロパティ名: 型」の形式で書きます"],
    explanation:
  ...
  },
  {
    ...
    hints: ["真偽値を表す型はbooleanです"],
    explanation: "booleanはtrue/falseの2値を取る基本型です。フラグやスイッチの状態を表すのに使います。",
  ...
  },
  {
    ...
    hints: ["Union型（|）を使うと複数の型を許容できます", "null と undefined は別々の型です"],
    explanation:
  ...
  },
  {
    ...
    hints: ["リテラル型は具体的な値を型として使用します", "Union型と組み合わせて使うことが多いです"],
    explanation:
  ...
  },
  {
    ...
    hints: ["配列型は型名の後ろに[]をつけます", "または Array<型名> という書き方もあります"],
    explanation:
  ...
  // 配列・タプル Level 1
  {
    ...
    hints: ["タプル型は角括弧 [ ] で定義します", "各要素の型を順番に記述します"],
    explanation:
  ...
  },
  {
    ...
    hints: ["readonly修飾子を使うと変更不可の配列になります", "ReadonlyArray<T>という書き方もあります"],
    explanation:
  ...
  {
    id: "arrays-tuples-1-05",
    category: "arrays-tuples",
    level: 1,
    difficulty: "easy",
    promptJa:
      "名前（string）、年齢（number）、アクティブ状態（boolean）の3要素を持つタプル型UserTupleを定義してください。",
    starterCode: "type UserTuple = // ここに型を書いてください",
    expectedAnswer: "type UserTuple = [string, number, boolean]",
    hints: ["タプルは複数の異なる型の要素を持てます"],
    explanation:
  ...
  // オブジェクト型 Level 1
  {
    ...
    hints: ["interfaceはオブジェクトの形状を定義します", "プロパティ名: 型; の形式で記述します"],
    explanation:
  ...
  },
  {
    ...
    starterCode: "type Person = // ここに型を書いてください",
    expectedAnswer: "type Person = { name: string; age?: number }",
    hints: ["オプショナルプロパティは ? を使います", "age?: number は age が undefined でもよいことを意味します"],
    explanation:
  ...
  {
    id: "object-types-1-03",
    category: "object-types",
    level: 1,
    difficulty: "easy",
    promptJa:
      "読み取り専用のidプロパティ（number）と変更可能なnameプロパティ（string）を持つUser型を定義してください。",
    starterCode: "type User = // ここに型を書いてください",
    expectedAnswer: "type User = { readonly id: number; name: string }",
    hints: ["readonly修飾子でプロパティを変更不可にできます"],
    explanation:
  ...
  {
    id: "object-types-1-05",
    category: "object-types",
    level: 1,
    difficulty: "easy",
    promptJa:
      "xとy（両方number）を持つPoint interfaceを拡張して、z（number）も追加したPoint3D interfaceを定義してください。",
  ...
  },
  {
    ...
    hints: ["Intersection型は & で複数の型を結合します", "両方の型のプロパティをすべて持つ型になります"],
    explanation:
  ...
  {
    id: "union-intersection-1-03",
    category: "union-intersection",
    level: 1,
    difficulty: "medium",
    promptJa:
      'type属性が"dog"の場合barkプロパティ、"cat"の場合meowプロパティを持つ、Discriminated Union型Animalを定義してください。',
  ...
  },
  {
    ...
    hints: ["ジェネリクスとUnion型を組み合わせます", "T | T[] で単一値または配列を表現できます"],
    explanation:
  ...
  },
  {
    ...
    hints: ["ジェネリクスを使って任意の型にnullを許容させます"],
    explanation:
  ...
  },
  {
    ...
    hints: ["戻り値がない関数はvoid型を使います", "引数がない場合は () を使います"],
    explanation: "voidは関数が値を返さないことを示します。イベントハンドラやコールバックによく使われます。",
  ...
  {
    id: "function-types-1-04",
    category: "function-types",
    level: 1,
    difficulty: "easy",
    promptJa:
      "オプショナルな第2引数を持つGreetFn型を定義してください。name（string）は必須、greeting（string）はオプションで、戻り値はstringです。",
    starterCode: "type GreetFn = // ここに型を書いてください",
    expectedAnswer: "type GreetFn = (name: string, greeting?: string) => string",
    hints: ["オプショナル引数は ? を使います", "オプショナル引数は必須引数の後に置きます"],
    explanation:
  ...
  },
  {
    ...
    hints: ["Rest parametersは ...名前: 型[] で定義します", "可変長引数を受け取れます"],
    explanation:
  ...
  // ジェネリクス Level 1
  {
    ...
    hints: ["ジェネリクスの型パラメータはプロパティの型として使えます"],
    explanation:
  ...
  },
  {
    ...
    hints: ["型パラメータにデフォルト値を設定できます", "= で指定したいデフォルト型を設定します"],
    explanation:
  ...
  },
  {
    ...
    difficulty: "medium",
    promptJa:
      "配列の要素型を取得するArrayElement<T>型を定義してください。Tが配列の場合その要素型を、そうでなければneverを返します。",
    starterCode: "type ArrayElement<T> = // ここに型を書いてください",
    expectedAnswer: "type ArrayElement<T> = T extends (infer U)[] ? U : never",
    hints: ["条件型 (extends ... ? A : B) を使います", "inferキーワードで配列の要素型を推論できます"],
    explanation:
  ...
  // ユーティリティ型 Level 1
  {
    ...
    hints: ["Pick<T, K>でオブジェクト型から特定のキーのみを抽出できます", "キーはUnion型で複数指定できます"],
    explanation:
  ...
  },
  {
    ...
    hints: ["Omit<T, K>でオブジェクト型から特定のキーを除外できます"],
    explanation: "Omit<T, K>は型Tから指定したキーKを除外した新しい型を作ります。Pickの逆の操作です。",
  ...
  },
  {
    ...
    hints: ["Partial<T>ですべてのプロパティをオプショナルにできます"],
    explanation:
  ...
  },
  {
    ...
    hints: ["Required<T>ですべてのプロパティを必須にできます"],
    explanation: "Required<T>は型Tのすべてのプロパティから?を取り除き、必須にします。Partialの逆の操作です。",
  ...
  },
  {
    ...
    hints: ["Readonly<T>ですべてのプロパティを読み取り専用にできます"],
    explanation: "Readonly<T>は型Tのすべてのプロパティにreadonlyを付加します。不変オブジェクトを表現するのに使います。",
  ...
  // 条件型 Level 1
  {
    ...
    hints: ["条件型は T extends U ? A : B の形式で書きます", "三項演算子に似た構文です"],
    explanation:
  ...
  },
  {
    ...
    hints: ["nullとundefinedのUnion型に対してextendsを使います", "neverは「存在しない」型を表します"],
    explanation:
  ...
  },
  {
    ...
    hints: ["inferキーワードで型変数を導入できます", "T extends (infer U)[] で配列の要素型Uを取得できます"],
    explanation:
  ...
  },
  {
    ...
    hints: ["関数型は (...args: any[]) => 戻り値 でマッチできます", "inferで戻り値の型を取得できます"],
    explanation:
  ...
  // Mapped Types Level 1
  {
    ...
    hints: ["Mapped Typeは { [K in keyof T]: 型 } の形式で書きます", "keyof Tでオブジェクトのキーを取得できます"],
    explanation:
  ...
  {
    id: "mapped-types-1-02",
    category: "mapped-types",
    level: 1,
    difficulty: "easy",
    promptJa:
      "オブジェクト型TのすべてのプロパティをオプショナルにするMyPartial<T>型を定義してください（Partialの再実装）。",
    starterCode: "type MyPartial<T> = // ここに型を書いてください",
    expectedAnswer: "type MyPartial<T> = { [K in keyof T]?: T[K] }",
    hints: ["プロパティをオプショナルにするには ? を使います", "T[K] で元の型を参照できます"],
    explanation:
  ...
  {
    id: "mapped-types-1-03",
    category: "mapped-types",
    level: 1,
    difficulty: "easy",
    promptJa:
      "オブジェクト型Tのすべてのプロパティを読み取り専用にするMyReadonly<T>型を定義してください（Readonlyの再実装）。",
    starterCode: "type MyReadonly<T> = // ここに型を書いてください",
    expectedAnswer: "type MyReadonly<T> = { readonly [K in keyof T]: T[K] }",
    hints: ["readonlyを追加するにはreadonly修飾子を使います"],
    explanation:
  ...
  },
  {
    ...
    hints: ["キーの集合Kに対してイテレートします", "K extends string でKが文字列のUnion型であることを制約します"],
    explanation:
  ...
  },
  {
    ...
    hints: ["K extends keyof T でKがTのキーであることを制約します", "Kに対してのみイテレートします"],
    explanation:
  ...
  },
  {
    ...
    hints: ["typeofを使うと変数から型を取得できます"],
    explanation: "typeofは値から型を抽出します。as constと組み合わせると、リテラル型を含む正確な型が得られます。",
  ...
  {
    id: "advanced-patterns-1-03",
    category: "advanced-patterns",
    level: 1,
    difficulty: "easy",
    promptJa: "isプredicate（型ガード）を使って、値がstringかどうかを判定するisString関数の型を定義してください。",
    starterCode:
      "function isString(value: unknown): // ここに戻り値の型を書いてください {\n  return typeof value === 'string';\n}",
    expectedAnswer: "function isString(value: unknown): value is string {\n  return typeof value === 'string';\n}",
    hints: ["型ガードは value is 型 の形式で書きます", "この関数がtrueを返すとき、valueはstring型として扱われます"],
    explanation:
  ...
  {
    id: "advanced-patterns-1-04",
    category: "advanced-patterns",
    level: 1,
    difficulty: "easy",
    promptJa:
      "satisfies演算子を使って、colorsオブジェクトの値がすべて`#`で始まる文字列（Record<string, `#${string}`>）であることをチェックしつつ、各プロパティのリテラル型（例: colors.red は '#ff0000'）を保持してください。",
    starterCode:
      "const colors = // satisfiesを使って書いてください\n  { red: '#ff0000', green: '#00ff00', blue: '#0000ff' };",
    expectedAnswer:
      "const colors = { red: '#ff0000', green: '#00ff00', blue: '#0000ff' } satisfies Record<string, `#${string}`>;",
    hints: ["satisfiesは型チェックしつつ、推論された型を保持します", "as constと違い、値の変更は可能です"],
    explanation:
      "satisfiesはTypeScript 4.9で追加された演算子です。型の制約をチェックしながら、推論された具体的な型を保持できます。制約がテンプレートリテラル型 `#${string}` なので文字列リテラルがwideningされず、colors.red は '#ff0000' 型になります。一方 `const colors: Record<string, `#${string}`> = ...` と型注釈を付けると、colors.red は `#${string}` 型になり、存在しないキーへのアクセスもエラーになりません。",
  ...
  },
  {
    ...
    hints: ["typeof でオブジェクトの型を取得し、keyof でキーのUnion型を取得します"],
    explanation:
